<img src="Assets/logodark.png#gh-dark-mode-only" alt="Xero">
<img src="Assets/logolight.png#gh-light-mode-only" alt="Xero">
...
You can load Xero through a GitHub Release:

```lua
local Xero = loadstring(game:HttpGet("https://github.com/dawid-scripts/Xero/releases/latest/download/main.lua"))()
```
<br/>

## 📜 Usage

[Example Script](https://github.com/kangdark/Xero/blob/master/Example.lua)
<br/>
